import { IconMail, IconMapPin, IconBrandGithub, IconBrandTelegram, IconBrandDiscord } from '@tabler/icons-react';
...
export const Contact = ({ user }: ContactProps) => {
    return (
        <section id="contact" className="py-20 bg-white/50 dark:bg-stone-950/10 transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-800 dark:text-cyan-300 mb-4 transition-colors">Get In Touch</h2>
                    <p className="text-lg sm:text-xl text-slate-600 dark:text-zinc-400 transition-colors">Let's connect and build something amazing together</p>
                </div>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        ...
                        <div className="liquid-card p-6 sm:p-8 text-center group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-slate-800 dark:text-cyan-300 mb-4">Email</h3>
                            <a 
                        ...
                        <div className="liquid-card p-6 sm:p-8 text-center group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-teal-400 to-teal-600 dark:from-zinc-600 dark:to-zinc-800 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg">
                                <IconBrandTelegram className="text-white" size={24} />
                            </div>
                            <h3 className="text-lg sm:text-xl font-bold text-slate-800 dark:text-cyan-300 mb-4">Telegram</h3>
                            <a 
                        ...
                        <div className="liquid-card p-6 sm:p-8 text-center group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 md:col-span-2 lg:col-span-1">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-slate-800 dark:text-cyan-300 mb-4">Discord Server</h3>
                            <a 
                        ...
                        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6 lg:space-x-8">
                            {user?.location && (
                                <div className="flex items-center justify-center space-x-3 liquid-card px-4 py-3 sm:px-6 sm:py-4">
                                    ...
                                    <span className="text-slate-700 dark:text-cyan-300 font-medium text-sm sm:text-lg">{user.location}</span>
                                </div>
                            )}
                            <div className="flex items-center justify-center space-x-3 liquid-card px-4 py-3 sm:px-6 sm:py-4">
                    ...
                    <div className="mt-16 text-center">
                        <div className="liquid-card p-6 sm:p-8 max-w-2xl mx-auto">
                            <h3 className="text-xl sm:text-2xl font-bold text-slate-800 dark:text-cyan-300 mb-4">Ready to collaborate?</h3>
                            <p className="text-slate-600 dark:text-zinc-400 text-sm sm:text-lg leading-relaxed">
                                I'm always interested in hearing about new projects and opportunities. 
                                Whether you want to work together or just say hi, feel free to reach out through any of the channels above!
                            </p>
                        </div>
                    </div>
                </div>
